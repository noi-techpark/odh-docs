...
.. changelog::
   ...
   .. change::
      ...
      The :ref:`changelogs` section was reorganised: entries of each
      year were moved to a separate page and issues were grouped
      according to their released version. Also, missing changelog
      entries for tickets :ticket:`263` and :ticket:`264` have been
      added.
